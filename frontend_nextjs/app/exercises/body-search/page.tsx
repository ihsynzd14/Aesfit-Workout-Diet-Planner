...
const muscles: Muscle[] = [
  { id: 98, cid:0, name: "Select a Body Part", name_en: "", is_front: true, svg_id: "null2" },
  { id: 99, cid:0, name: "Select a Body Part", name_en: "", is_front: true, svg_id: "null" },
  { id: 13,cid:13, name: "Rear Delts", name_en: "Deltoideus (posterior)", is_front: true, svg_id: "rear-delt" },
  { id: 2,cid:13, name: "Shoulders", name_en: "Deltoideus (anterior)", is_front: true, svg_id: "front-shoulders" },
  { id: 1,cid:8, name: "Biceps", name_en: "Biceps brachii", is_front: true, svg_id: "biceps" },
  { id: 11,cid:9, name: "Hamstrings", name_en: "Ischiocrurale", is_front: true, svg_id: "hamstrings" },
  { id: 13,cid:8, name: "Forearms", name_en: "Antebrachii", is_front: true, svg_id: "brachialis" },
  { id: 7,cid:14, name: "Calves", name_en: "Gastrocnemius", is_front: true, svg_id: "calves" },
  { id: 8, cid:9,name: "Glutes", name_en: "Glutei", is_front: true, svg_id: "glutes" },
  { id: 12,cid:12, name: "Lats", name_en: "Latissimus dorsi", is_front: true, svg_id: "lats" },
  { id: 4,cid:11, name: "Chest", name_en: "Pectoralis major", is_front: true, svg_id: "chest" },
  { id: 10, cid:9,name: "Quads", name_en: "Quadriceps femoris", is_front: true, svg_id: "quads" },
  { id: 6,cid:10, name: "Abs", name_en: "Rectus abdominis", is_front: true, svg_id: "abdominals" },
  { id: 14,cid:10, name: "Obliques", name_en: "Obliqui externi abdominis", is_front: true, svg_id: "obliques" },
  { id: 15,cid:14, name: "Soleus", name_en: "Soleus", is_front: false, svg_id: "soleus" },
  { id: 9,cid:12, name: "Traps", name_en: "Trapezius", is_front: true, svg_id: "traps" },
  { id: 5,cid:8, name: "Triceps", name_en: "Triceps brachii", is_front: true, svg_id: "triceps" },
];
...
export default function AnatomyPage() {
  ...
  const handleShowWorkouts = () => {
    if (selectedMuscle) {
      router.push(`/exercises/${selectedMuscle.cid}/${selectedMuscle.id}`);  // Use router.push instead of navigate
    }
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="flex flex-col md:flex-row justify-center items-start space-y-6 md:space-y-0 md:space-x-6">
        <div className="relative">
          ...
          >
            ...
            {muscles
              .filter((muscle) => muscle.is_front === (view === 'front'))
              .map((muscle) => (
                <><g
                  key={muscle.id}
                  id={muscle.svg_id}
                  className={`bodymap ${selectedMuscle?.id === muscle.id
                      ? 'text-red-500'
        ...
        <Card className="w-full md:w-64">
          <CardHeader>
            <CardTitle>Selected Muscle</CardTitle>
          </CardHeader>
          <CardContent>
            <AnimatePresence mode="wait">
              {selectedMuscle ? (
                ...
                >
                  <p className="font-bold">{selectedMuscle.name}</p>
                  <p>{selectedMuscle.name_en}</p>
      ...
      <AlertDialog open={showWorkoutDialog} onOpenChange={setShowWorkoutDialog}>
      <AlertDialogContent>
        <AlertDialogHeader>
          <AlertDialogTitle>View Workouts</AlertDialogTitle>
          <AlertDialogDescription>
            Would you like to see workouts for the {selectedMuscle?.name}?
          </AlertDialogDescription>
        </AlertDialogHeader>
        <AlertDialogFooter>
          <AlertDialogCancel>Cancel</AlertDialogCancel>
          <AlertDialogAction onClick={handleShowWorkouts}>View Workouts</AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
    </AlertDialog>
    </div>
